...
while keep_asking:
    ...
    if temp_input == 1:
        ...
        if temp_input not in lst1:
            print("Wrong input. Enter a number 1, 2 or 3, or type Y for random choice.:")
    

    if (temp_input == 'y') or (temp_input == 'yes') or (temp_input == 'Y') or (temp_input == 'Yes') or (temp_input == 'YES'):
        if choose_rand == 1:
            print("I've chosen the first template for you. Just give me answers.")
            first_temp()
            keep_asking = False
        elif choose_rand == 2:
            print("I've chosen the second template for you. Just give me answers.")
            second_temp()
            keep_asking = False
        elif choose_rand == 3:
